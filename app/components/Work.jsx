    ...
    transition={{duration:0.6 , delay:0.9}}
      className='grid grid-cols-[repeat(auto-fit,_minmax(200px,_1fr))] gap-5 my-10 dark:text-black'>
              {workData.map((project, index) => (
                  ...
                  className='aspect-square bg-no-repeat bg-cover bg-center bg-lg relative cursor-pointer group' style={{backgroundImage: `url(${project.bgImage})`}} key={index}>
      ...
      transition={{duration: 0.5 , delay:1.1}}
       href='' className='w-max flex items-center justify-center gap-2 text-gray-700 border-[0.5px] border-gray-700 rounded-full py-3 px-10  mx-auto my-20 hover:[background-color:#fcf4ff] duration-500 dark:text-white dark:border-white dark:hover:bg-darkHover'>
